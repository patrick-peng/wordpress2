				...
				$reset = false;
								...
								$args=array( 
									...
									'tax_query' => array(
										array(
											...
											'field'    =>	'id',
											'terms'    =>	 !empty($selectedPortfolioCatetegories) ? $selectedPortfolioCatetegories : '',
											'operator' => 	 !empty($selectedPortfolioCatetegories) ? "IN" : "OR"
										)
									),																		
								);
								...
								$args=array( 
									...
									'tax_query' => array(
										array(
											...
											'field'    =>	'id',
											'terms'    =>	 (@$template->categories) ? wpml_lang_object_ids($template->categories,"product_categories") : '',
					...
					if($template->content_type=="google_map"){ 			 
						...
						echo '<div class="template_builder box-shadow box '.$layout.' '.$firstBox.'  '.$lastBox.'">';
							...
							echo '<div class="video-container">'.$mapiframeCode.'</div>'; 
