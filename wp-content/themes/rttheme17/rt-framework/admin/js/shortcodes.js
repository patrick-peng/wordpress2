	...
	tinymce.create('tinymce.plugins.rt_theme_shortcodes', {
		init : function(ed, url) {
			...
			ed.addButton('rt_themeshortcode_13', {
					...
					onclick : function() {
						window.tinyMCE.execInstanceCommand(window.tinyMCE.activeEditor.editorId, 'mceInsertContent', false, '[product_showcase categories="" ids="" columns="4" limit="12" desc="true" orderby="date" order="DESC"]<br /><br /> ');
						window.tinyMCE.activeEditor.execCommand('mceRepaint');
