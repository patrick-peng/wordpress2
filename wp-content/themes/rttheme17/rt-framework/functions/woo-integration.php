...
// add_action('woocommerce_after_single_product','xiangloveqin',10);
...
$learning_center_value = get_post_meta( $post->ID, 'general_details', true );
	...
	if((!empty($general_details_value))||(!empty($paper_specs_value))||(!empty($packing_shipment_value))||(!empty($learning_center_value))){
	?>
			...
			<div class="box one box-shadow margin-b30">
				<div class="head_text nomargin">
					<div class="woocommerce-tabs">
						<ul class="tabs">
						<?php if(!empty($general_details_value)){ ?>
							<li class="reviews_tab" style="width: 24%;">
								<a href="#tab-description" class="current">General Details</a>
							</li>
						<?php } ?>
						<?php if(!empty($paper_specs_value)){ ?>
							<li class="reviews_tab" style="width: 24%;">
								<a href="#tab-reviews">Paper & Specs</a>
							</li>
							<?php } ?>
						<?php if(!empty($packing_shipment_value)){ ?>
							<li class="reviews_tab" style="width: 24%;">
								<a href="#tab-reviews1">Packing & shipment</a>
							</li>
							<?php } ?>
						<?php if(!empty($learning_center_value)){ ?>
							<li class="reviews_tab" style="width: 24%;">
								<a href="#tab-reviews2">Learning center</a>
							</li>
							<?php } ?>
						</ul>
			<div class="panel entry-content" id="tab-description" style="display: block;">
				<?php echo $general_details_value; ?>
			</div>
			<div class="panel entry-content" id="tab-reviews" style="display: none;">
				<?php echo $paper_specs_value; ?>
			</div>
			<div class="panel entry-content" id="tab-reviews1" style="display: none;">
				<?php echo $packing_shipment_value; ?>
			</div>
			<div class="panel entry-content" id="tab-reviews2" style="display: none;">
				<?php echo $learning_center_value; ?>
			</div>
		</div>
	</div>
	</div>
